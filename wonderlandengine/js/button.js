...
export class ButtonComponent extends Component {
    ...
    onDown = (_, cursor) => {
        ...
        //this.rotate.speed = 1000;
        //this.rotate.active = !this.rotate.active;
        prompt = `You are javascript developer. only return plain javascript code.  \
        given this code, this.rotate.speed = 500;
        ...
        fetch('http://localhost:11434/api/generate', {
            ...
            .then(data => { 
                //eval("this.rotate.active = !this.rotate.active;");
